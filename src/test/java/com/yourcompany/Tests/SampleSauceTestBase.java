...
public class SampleSauceTestBase implements SauceOnDemandSessionIdProvider {
    ...
    public static LinkedList browsersStrings() {
        ...
        browsers.add(new String[] {"Android", "Samsung Galaxy S4 Emulator", "4.4", "1.4.16", "portrait"});
        browsers.add(new String[] {"Android", "Android Emulator", "5.1", "1.4.16", "portrait"});
        browsers.add(new String[] {"Android", "Samsung Galaxy Nexus Emulator", "4.4", "1.4.16", "portrait"});
        
        //Real device target
        //browsers.add(new String[] {"Android", "Samsung Galaxy S4 device", "4.4", "1.4.16", "portrait"});
        //browsers.add(new String[] {"Android", "Samsung Galaxy S5 device", "4.4", "1.4.16", "portrait"});
